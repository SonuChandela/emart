                        ...
                        <Row>
                            {
                                products?.map((product) => (
                                    <Col key={product.id} lg={3} md={6} xs={6} data-aos="fade-up" data-aos-duration="700">
                                ...
                                <div className="product-card">
                                    ...
                                    <div className="product-card-details">
                                        <ul className="color-lists list-unstyled d-flex align-items-center">
                                            ...
                                            <li><a href="javascript:void(0)" className="color-swatch swatch-cyan"></a></li>
                                            <li><a href="javascript:void(0)" className="color-swatch swatch-purple"></a>
                                            </li>
                                        </ul>
