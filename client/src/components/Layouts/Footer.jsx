    ...
    return (
        ...
        <footer className="mt-100 overflow-hidden">
                ...
                <Container>
                    <div className="footer-widget-wrapper">
                        <Row className="justify-content-between">
                            <Col lg={2} md={6} xs={12} xl={2} className="footer-widget">
                                <div className="footer-widget-inner">
                                    ...
                                    <ul className="footer-menu list-unstyled mb-0 d-md-block">
                                        <li className="footer-menu-item"><Link to="about-us.html">About us</Link></li>
                                        <li className="footer-menu-item"><Link to="about-us.html">Press center</Link></li>
                                        <li className="footer-menu-item"><Link to="blog.html">Our magazine</Link></li>
                                        <li className="footer-menu-item"><Link to="about-us.html">Our group</Link></li>
                                        <li className="footer-menu-item"><Link to="about-us.html">Work with us</Link></li>
                                    </ul>
                                </div>
                            </Col>
                            <Col lg={2} md={6} xs={12} xl={2} className="footer-widget">
                                <div className="footer-widget-inner">
                                    ...
                                    <ul className="footer-menu list-unstyled mb-0 d-md-block">
                                        <li className="footer-menu-item"><Link to="about-us.html">Brand catalog</Link></li>
                                        <li className="footer-menu-item"><Link to="about-us.html">Discount codes</Link></li>
                                        <li className="footer-menu-item"><Link to="collection-left-sidebar.html">Furniture</Link></li>
                                        <li className="footer-menu-item"><Link to="collection-left-sidebar.html">Sofa</Link></li>
                                        <li className="footer-menu-item"><Link to="collection-left-sidebar.html">Chair</Link></li>
                                    </ul>
                                </div>
                            </Col>
                            <Col lg={2} md={6} xs={12} xl={2} className="footer-widget">
                                <div className="footer-widget-inner">
                                    ...
                                    <ul className="footer-menu list-unstyled mb-0 d-md-block">
                                        <li className="footer-menu-item"><Link to="faq.html">Chair</Link></li>
                                        <li className="footer-menu-item"><Link to="about-us.html">Privacy policy</Link></li>
                                        <li className="footer-menu-item"><Link to="about-us.html">Support</Link></li>
                                        <li className="footer-menu-item"><Link to="contact.html">Contact</Link></li>
                                    </ul>
                                </div>
                            </Col>
                            <Col lg={5} md={6} xs={12} xl={4} className="footer-widget">
                                <div className="footer-widget-inner">
                                    <h4 className="footer-logo">
                                        <Link to="/"><img src={WhiteLogo} alt="bisum"/></Link>
                                    </h4>
                                    <div className="footer-newsletter">
                                        ...
                                        <div className="newsletter-wrapper">
                                            <form action="#" className="footer-newsletter-form d-flex align-items-center">
                                                <input className="footer-newsletter-input bg-transparent" type="email"
                                                    placeholder="Your e-mail" autoComplete="off"/>
                                                <button className="footer-newsletter-btn newsletter-btn-white"
                                                    type="submit">SIGN
                                                    UP</button>
                                            </form>
                                        </div>
                                        <div className="footer-social-wrapper">
                                            <ul
                                                className="footer-social list-unstyled d-flex align-items-center flex-wrap mb-0">
                                                <li className="footer-social-item">
                                                    <Link to="#">
                                                        <svg className="icon icon-twitter" width="20" height="20"
                                                ...
                                                <li className="footer-social-item">
                                                    <Link to="#">
                                                        <svg className="icon icon-facebook" width="20" height="20"
                                                            viewBox="0 0 20 20" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                ...
                                                <li className="footer-social-item">
                                                    <Link to="#">
                                                        <svg className="icon icon-instagram" width="20" height="20"
                                                            viewBox="0 0 20 20" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                                ...
                                                <li className="footer-social-item">
                                                    <Link to="#">
                                                        <svg className="icon icon-tiktok" width="20" height="20"
                                                            viewBox="0 0 20 20" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <li className="footer-social-item">
                                                    <Link to="#">
                                                        <svg className="icon icon-youtube" width="20" height="20"
                                                            viewBox="0 0 20 20" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
            ...
            <div className="footer-bottom bg-4">
                <Container>
                    <div
                        className="footer-bottom-inner d-flex flex-wrap justify-content-md-between justify-content-center align-items-center">
                        <ul className="footer-bottom-menu list-unstyled d-flex flex-wrap align-items-center mb-0">
                            <li className="footer-menu-item"><Link to="about-us.html">Privacy policy</Link></li>
                            <li className="footer-menu-item"><Link to="about-us.html">Terms & Conditions</Link></li>
                        </ul>
                        <p className="copyright footer-text">©<span className="current-year"></span> Spree Themes.</p>
                    </div>
                </Container>
            </div>
        </footer>
         ...
         {/* scrollup start  */}
        <button id="scrollup">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="18 15 12 9 6 15"></polyline></svg>  
        </button>
         {/* scrollup end */}
