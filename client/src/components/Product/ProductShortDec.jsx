...
import { updateQuantity } from "../../store/Features/CartSlice";
...
function ProductDec({ productData }) {
    // redux dispatch method 
    const dispatch = useDispatch();
    const { id, title, brand, images, category, stock, price, quantity } = productData
    ...
    // refernce for primary slider
    let largeSliderRef = useRef(null);
    // refernce for secondary slider
    let thumbSliderRef = useRef(null);
    ...
    const handleNext = () => {
        thumbSliderRef.slickNext();
    };

    // Function to handle previous slide
    const handlePrev = () => {
        thumbSliderRef.slickPrev();
    };
    ...
    const primarySettings = {
        ...
        slidesToScroll: 1,
        slidesToShow: 1,
        asNavFor: thumbSliderRef.current, // Pass the reference to the thumb slider
        draggable: true,
    };
    ...
    const secondarySettings = {
        ...
        swipeToSlide: true,
        slidesToShow: 5,
        asNavFor: largeSliderRef.current, // Pass the reference to the large slider
        draggable: true,
        responsive: [
            {
                breakpoint: 768,
    ...
    const updateCart = (e) => {
        e.preventDefault();
        dispatch(updateQuantity({ cartItem: productData, itemQuantity: productQty }));
    }
    ...
    const handleQuantity = (action) => {
        if (action === 'increment' && productQty < 10) {
            setProductQty(prevProductQty => prevProductQty + 1);
        } else if (action === 'decrement' && productQty > 0) {
            setProductQty(prevProductQty => prevProductQty - 1);
        }
    }

    useEffect(() => {
        setLargeSlide(largeSliderRef);
        setThumbSlide(thumbSliderRef);
    }, []);
            ...
            <Row>
                <Col lg={6} md={12} xs={12}>
                    <div className="product-gallery product-gallery-vertical d-flex">
                        <div className="product-img-large">
                            <Slider {...primarySettings} asNavFor={thumbSlide} ref={slider => (largeSliderRef = slider)}>
                                {
                                    images?.map((image) => {
                                        return (
                                            <div key={id} className="img-large-wrapper">
                        ...
                        <div className="product-img-thumb">
                            <Slider {...secondarySettings} asNavFor={largeSlide} ref={slider => (thumbSliderRef = slider)}>
                                {
                                    images?.map((image) => {
                                        return (
                                            <div key={id} className="px-2 px-md-0 px-lg-0">
                ...
                <Col lg={6} md={12} xs={12}>
                    <div className="product-details ps-lg-4">
                        ...
                        <div className="product-sku product-meta mb-1">
                            <strong className="label">Brand:</strong> {brand}
                        </div>
                        <div className="product-sku product-meta mb-1">
                            <strong className="label">Stock:</strong> {stock}
                        </div>
                        <div className="product-vendor product-meta mb-3">
                            <strong className="label">Vendor:</strong> {category}
                        </div>
                        ...
                        <div className="product-variant-wrapper">
                            <div className="product-variant product-variant-color">
                                ...
                                <ul className="variant-list list-unstyled d-flex align-items-center flex-wrap">
                                    <li className="variant-item">
                                        <input type="radio" value="cyan" id="cyan" checked={colorOption === 'cyan'}
                                            onChange={handleColorChange}
                                        />
                                        <label className="variant-label swatch-cyan" htmlFor="cyan"></label>
                                    </li>
                                    <li className="variant-item">
                                        <input type="radio" value="black" id="black" checked={colorOption === 'black'}
                                            onChange={handleColorChange}
                                        />
                                        <label className="variant-label swatch-black" htmlFor="black"></label>
                                    </li>
                                    <li className="variant-item">
                                        <input type="radio" value="purple" id="purple" checked={colorOption === 'purple'} onChange={handleColorChange} />
                                        <label className="variant-label swatch-purple" htmlFor="purple"></label>
                                    </li>
                                    <li className="variant-item">
                                        <input type="radio" value="blue" id="blue" checked={colorOption === 'blue'} onChange={handleColorChange} />
                                        <label className="variant-label swatch-blue" htmlFor="blue"></label>
                                    </li>
                                    <li className="variant-item">
                                        <input type="radio" value="orange" id="orange" checked={colorOption === 'orange'} onChange={handleColorChange} />
                                        <label className="variant-label swatch-orange" htmlFor="orange"></label>
                                    </li>
                                    <li className="variant-item">
                                        <input type="radio" value="teal" id="teal" checked={colorOption === 'teal'} onChange={handleColorChange} />
                                        <label className="variant-label swatch-teal" htmlFor="teal"></label>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="product-variant product-variant-other">
                                ...
                                <ul className="variant-list list-unstyled d-flex align-items-center flex-wrap">
                                    <li className="variant-item">
                                        <input type="radio" value="34" id="34" checked={sizeOption === '34'} onChange={handleSizeChange} />
                                        <label className="variant-label" htmlFor="34">34</label>
                                    </li>
                                    <li className="variant-item">
                                        <input type="radio" value="36" id="36" checked={sizeOption === '36'} onChange={handleSizeChange} />
                                        <label className="variant-label" htmlFor="36">36</label>
                                    </li>
                                    <li className="variant-item">
                                        <input type="radio" value="38" id="38" checked={sizeOption === '38'} onChange={handleSizeChange} />
                                        <label className="variant-label" htmlFor="38">38</label>
                                    </li>
                                    <li className="variant-item">
                                        <input type="radio" value="40" id="40" checked={sizeOption === '40'} onChange={handleSizeChange} />
                                        <label className="variant-label" htmlFor="40">40</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="misc d-flex align-items-end justify-content-between mt-4">
                            <div className="quantity d-flex align-items-center justify-content-between">
                                <button className="qty-btn dec-qty" onClick={() => handleQuantity('decrement')}><img src={Minus}
                                    alt="minus" /></button>
                                <span className="qty-input">{productQty}</span>
                                <button className="qty-btn inc-qty" onClick={() => handleQuantity('increment')}><img src={Plus}
                                    alt="plus" /></button>
                            </div>
                        ...
                        <div
                            ...
                            <button type="submit"
                                className="position-relative btn-atc btn-add-to-cart loader" onClick={updateCart}>ADD TO
                                CART</button>
                            <a href="#" className="product-wishlist" onClick={addWishList}>
                        ...
                        <div className="buy-it-now-btn mt-2">
                            <Link className="position-relative btn-atc btn-buyit-now" to='/cart'>BUY IT
                                NOW</Link>
                        </div>


                        <div className="guaranteed-checkout">
                            <strong className="label mb-1 d-block">Guaranteed safe checkout:</strong>
                            <ul
                                className="list-unstyled checkout-icon-list d-flex align-items-center flex-wrap">
